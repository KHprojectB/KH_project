  ...
  return (
    <div className={styles.nav}>
      <ul className={styles.navlist}>
        ...
        <li>
          <button className={styles["nav-toggle"]} onClick={updateSort} value={sort}>
            <option className={styles.text} value="name-a">이름순 ㄱ-ㅎ</option>
          </button>
        </li>
        <li>
          <button className={styles["nav-toggle"]} onClick={updateSort} value={sort}>
            <option className={styles.text} value="name-z">이름순 ㅎ-ㄱ</option>
          </button>
        </li>
      </ul>
    </div>
